<?php
	...
	if(isset($_GET['e']) && $_GET['e'] != "") {
		...
		$eventQuery = $mysqli->query("SELECT * FROM `events` WHERE `category_url` = '$e'");
	...
	echo $db->uploadEventImg($mysqli,$eventID);
	...
	<div align="center">
		<div class="container">
			...
			<div class="frame">
				...
				<?php echo $db->workDesc($mysqli,"events",$event,$eventID); ?>
				<?php echo $db->displayEventColumn($mysqli,$eventID); ?>
