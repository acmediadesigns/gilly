...
<html>
<head>
<title>Gilly Flowers &amp Events | Get a Quote</title>
	...
	<div align="center">
		<div class="container">
			...
			<div class="frame">
				...
				<?php echo $base->pageHeader("Get a Quote","Fill Out Your Information"); ?>
				<?php echo $base->quoteInfo(); ?>
				<?php echo $base->quoteForm(); ?>
